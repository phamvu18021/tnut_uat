  ...
  const benefits = [
    {
      path: "#",
      title:
        home_content?.acf?.loi_ich?.loi_ich_1.loi_ich_title ||
        ".Thời gian Đào tạo ngắn",
      desc:
        home_content?.acf?.loi_ich?.loi_ich_1.loi_ich_desc ||
        "• .Người học có thể học vượt để rút ngắn thời gian học tập theo quy định đào tạo tín chỉ ",
      descs:
        home_content?.acf?.loi_ich?.loi_ich_1.loi_ich_descs ||
    ...
    },
    {
      path: "#",
      title:
        home_content?.acf?.loi_ich?.loi_ich_2.loi_ich_title ||
        ".Bằng Đại học uy tín ",
      desc:
        home_content?.acf?.loi_ich?.loi_ich_2.loi_ich_desc ||
        "• .Bằng không ghi hình thức đào tạo và được Bộ GD&ĐT công nhận ",
      descs:
        home_content?.acf?.loi_ich?.loi_ich_2.loi_ich_descs ||
    ...
    },
    {
      path: "#",
      title:
        home_content?.acf?.loi_ich?.loi_ich_3.loi_ich_title || ".Tư vấn 24/7",
      desc:
        home_content?.acf?.loi_ich?.loi_ich_3.loi_ich_desc ||
        "• .Tư vấn lộ trình học miễn phí",
      descs:
        home_content?.acf?.loi_ich?.loi_ich_3.loi_ich_descs ||
    ...
    },
    {
      path: "#",
      title:
        home_content?.acf?.loi_ich?.loi_ich_4.loi_ich_title ||
        ".Kho học liệu đa dạng",
      desc:
        home_content?.acf?.loi_ich?.loi_ich_4.loi_ich_desc ||
        "• .Tài liệu học tập đa Phương tiện (video, slide, script,..) ",
      descs:
        home_content?.acf?.loi_ich?.loi_ich_4.loi_ich_descs ||
      ...
      <Container maxW="7xl">
        <Text
          ...
          dangerouslySetInnerHTML={{
            __html: cleanText(
              home_content?.acf?.title_section_3 ||
