...
export const NganhKyThuatXayDung = async () => {
  ...
  return (
    <MajorPageLayout
      image={pageContent?.acf?.breadcrumbs_com?.image || "/nganh-xay-dung.webp"}
      title={pageContent?.acf?.breadcrumbs_com?.title || "Kỹ thuật xây dựng"}
