...
const Ktmt = dynamic(
  () =>
    import("@/features/nganh-ky-thuat-may-tinh").then(
      (mod) => mod.NganhKyThuatMayTinh
    ),
  {
    loading: () => <Loading />
  }
...
export const getServerSideProps: GetServerSideProps = async (context: any) => {
  ...
  const api_url = `${api_rm_url}/ky-thuat-may-tinh`;
  try {
    ...
    console.error("fetch failed ktmt" + error);
    return {
      props: {
        head: null
      }
